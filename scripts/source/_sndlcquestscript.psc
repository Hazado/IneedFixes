...
Function DLCMaintenance()
	...
	If StrangeBrew
		If !HunterbornInstalled
			...
			Utility.Wait(1.0)
		EndIf
		_DS_KW_Food_Soup = Game.GetFormFromFile(0x28CD32, "Hunterborn.esp") as Keyword
	...
	If (Game.GetFormFromFile(0x0A2A3F, "Complete Alchemy & Cooking Overhaul.esp") as Bool)
		CACOInstalled = True
	Else
		CACOInstalled = False
	EndIf
